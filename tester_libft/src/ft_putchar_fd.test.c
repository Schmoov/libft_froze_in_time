...
{
	int fd_test = open("txt/tested_putchar.txt", O_WRONLY | O_CREAT, 444);
	...
	close(fd_test);
	fd_test = open("txt/tested_putchar.txt", O_RDONLY);

	int fd_expec = open("txt/expected_putchar.txt", O_RDONLY);
